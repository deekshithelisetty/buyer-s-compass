...
import { ChevronDown, Filter, Sparkles, X, Mic, ArrowRight, Search } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center gap-4">
          ...
          <form onSubmit={handleSearch} className="flex-1 max-w-xl mx-auto">
            <div className="relative">
              {/* Glassy border */}
              <div className="absolute -inset-1 rounded-full bg-muted/40 backdrop-blur-sm border border-border/50" />
              {/* Aurora glow on focus */}
              <div 
                className={`absolute -inset-[6px] rounded-full blur-md transition-opacity duration-500 ${isFocused ? 'opacity-50' : 'opacity-0'}`}
              ...
              <div 
                ...
                style={{ background: 'conic-gradient(from 0deg, #0081CF, #FFD700, #FF6FD8, #9B59B6, #00ffbf, #0081CF)' }}
              />
              <div className="relative flex items-center bg-muted rounded-full shadow-sm border border-border/30">
                ...
                <button 
                  type="submit" 
                  className="p-2 mr-1.5 rounded-full bg-[#0081CF] text-white hover:bg-[#006bb3] transition-colors"
                >
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="flex gap-6">
          ...
          <div className="hidden lg:block w-80 flex-shrink-0 animate-slide-in-right delay-300">
            <div className="sticky top-24 bg-gradient-to-br from-card to-muted/50 rounded-2xl border border-border/50 p-5 shadow-lg">
              {/* Close button */}
