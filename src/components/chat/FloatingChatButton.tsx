...
export function FloatingChatButton({ onClick }: FloatingChatButtonProps) {
  return (
    ...
    >
      {/* Soft glow effect */}
      <div
        className="absolute inset-0 rounded-full blur-xl opacity-60 animate-[pulse_2s_ease-in-out_infinite]"
        style={{
      ...
      <svg
        ...
        viewBox="0 0 72 72"
        fill="none"
        style={{ filter: "drop-shadow(0 4px 8px rgba(255,182,193,0.4))" }}
      >
        <defs>
        ...
        {/* Main bubble body */}
        <path
          d="M10 28 C10 14 22 6 36 6 C50 6 62 14 62 28 L62 40 C62 54 50 62 36 62 L28 62 L20 70 L20 62 C14 60 10 52 10 40 Z"
          fill="url(#kawaiiBody)"
        />
        ...
        {/* Heart accent */}
        <path
          d="M58 52 C58 50 60 48 62 50 C64 48 66 50 66 52 C66 56 62 58 62 58 C62 58 58 56 58 52"
          fill="#FF6B8A"
          opacity="0.8"
        />
      </svg>
